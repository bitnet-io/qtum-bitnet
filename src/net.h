...
static constexpr std::chrono::minutes TIMEOUT_INTERVAL{2};
...
static const int MAX_OUTBOUND_FULL_RELAY_CONNECTIONS = 18;
/** Maximum number of addnode outgoing nodes */
static const int MAX_ADDNODE_CONNECTIONS = 18;
...
static const size_t DEFAULT_MAXRECEIVEBUFFER = 5 * 100000;
static const size_t DEFAULT_MAXSENDBUFFER    = 1 * 100000;
